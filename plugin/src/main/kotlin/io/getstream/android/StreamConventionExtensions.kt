...
abstract class StreamModuleExtension @Inject constructor(objects: ObjectFactory) {
    ...
    /** Whether to enable Spotless formatting in this specific module. Default: true */
    val spotlessEnabled: Property<Boolean> = objects.property<Boolean>().convention(true)
}
